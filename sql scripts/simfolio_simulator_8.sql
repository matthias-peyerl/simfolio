...
-- Establish the new strategy
CALL strategy_configuration();
 


/* OPTIONAL STEPS
STEP 5 - DEFINE A PORTFOLIO
1. You can have a look at existing portfolios and within the portfolio table. 
   To see the respective assets and their allocation within the portfolio, 
   use the portfolio id, to look them up in the portfolio_asset table. 
