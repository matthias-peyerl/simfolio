...
CREATE TEMPORARY TABLE sim_temp ( -- Temporary table for a simulation
    ...
    a1_preallocation FLOAT,
	a2_preallocation FLOAT,
	a3_preallocation FLOAT,
	a4_preallocation FLOAT,
...
ON t1.date = t2.date
SET 
a1_preallocation = t2.a1_prev_allocation,
a2_preallocation = t2.a2_prev_allocation,
a3_preallocation = t2.a3_prev_allocation,
a4_preallocation = t2.a4_prev_allocation,
t1.a1_amount 				= IF(ABS(t2.a1_prev_allocation - @a1_allocation) / @a1_allocation > @p_rel_rebalancing / 100 
								AND ABS(t2.a1_prev_allocation - @a1_allocation) > @p_min_rebalancing,
									FLOOR(t2.prev_tot_balance * COALESCE(@p_leverage / 100 + 1, 1) * @a1_allocation / 100 / a1_portfolio_price),
                                    t2.prev_a1_amount),
t1.a2_amount 				= IF(ABS(t2.a2_prev_allocation - @a2_allocation) / @a2_allocation > @p_rel_rebalancing / 100 
								AND ABS(t2.a1_prev_allocation - @a2_allocation) > @p_min_rebalancing,
									FLOOR(t2.prev_tot_balance * COALESCE(@p_leverage / 100 + 1, 1) * @a2_allocation / 100 / a2_portfolio_price),
                                    t2.prev_a2_amount),
t1.a3_amount 				= IF(ABS(t2.a3_prev_allocation - @a3_allocation) / @a3_allocation > @p_rel_rebalancing / 100 
								AND ABS(t2.a3_prev_allocation - @a3_allocation) > @p_min_rebalancing,
									FLOOR(t2.prev_tot_balance * COALESCE(@p_leverage / 100 + 1, 1) * @a3_allocation / 100 / a3_portfolio_price),
                                    t2.prev_a3_amount),
t1.a4_amount 				= IF(ABS(t2.a4_prev_allocation - @a4_allocation) / @a4_allocation > @p_rel_rebalancing / 100 
								AND ABS(t2.a4_prev_allocation - @a4_allocation) > @p_min_rebalancing,
