...
ON t1.date = t2.date
SET 
t1.a1_amount 				= IF((ABS(t2.a1_prev_allocation * 100 - @a1_allocation) / @a1_allocation >= @p_rel_rebalancing / 100 
                                ...
                                OR ABS(prev_leverage_rate *100 - @p_leverage) >= @p_lev_rebalancing,
                                    ...
                                    t2.prev_a1_amount),                         										                                   
t1.a2_amount 				= IF((ABS(t2.a2_prev_allocation * 100 - @a2_allocation) / @a2_allocation >= @p_rel_rebalancing / 100 
                                ...
                                OR ABS(prev_leverage_rate *100 - @p_leverage) >= @p_lev_rebalancing,
                                    ...
                                    t2.prev_a2_amount),
t1.a3_amount 				= IF((ABS(t2.a3_prev_allocation * 100 - @a3_allocation) / @a3_allocation >= @p_rel_rebalancing / 100 
                                ...
                                OR ABS(prev_leverage_rate *100 - @p_leverage) >= @p_lev_rebalancing,
                                    ...
                                    t2.prev_a3_amount),
t1.a4_amount 				= IF((ABS(t2.a4_prev_allocation * 100 - @a4_allocation) / @a4_allocation >= @p_rel_rebalancing / 100 
