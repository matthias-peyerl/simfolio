...
ON t1.date = t2.date
SET 
t1.a1_amount 				= IF( (ABS(a1_prev_allocation - @a1_allocation) > @p_min_rebalancing AND (ABS(a1_prev_allocation - @a1_alloaction) / @a1_allocation) > @p_rel_rebalancing / 100),
									FLOOR(t2.prev_tot_balance * COALESCE((SELECT leverage FROM strategies WHERE strategy_name = @strategy)/100+1,1) * @a1_allocation/100/a1_portfolio_price),
                                    prev_a1_amount),
t1.a2_amount 				= IF( (ABS(a2_prev_allocation - @a2_allocation) > @p_min_rebalancing AND (ABS(a2_prev_allocation - @a2_alloaction) / @a2_allocation) > @p_rel_rebalancing / 100),
                                    ...
                                    prev_a2_amount),
t1.a3_amount 				= IF( (ABS(a3_prev_allocation - @a3_allocation) > @p_min_rebalancing AND (ABS(a3_prev_allocation - @a3_alloaction) / @a3_allocation) > @p_rel_rebalancing / 100),
                                    ...
                                    prev_a3_amount),
t1.a4_amount 				= IF( (ABS(a1_prev_allocation - @a4_allocation) > @p_min_rebalancing AND (ABS(a4_prev_allocation - @a4_alloaction) / @a4_allocation) > @p_rel_rebalancing / 100),
